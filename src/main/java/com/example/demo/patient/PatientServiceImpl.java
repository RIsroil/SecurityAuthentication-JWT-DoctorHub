...
public class PatientServiceImpl implements PatientService { // Implements PatientService
    private final UserRepository userRepository;
    private final PatientMapper patientMapper = PatientMapper.INSTANCE; // Added
    ...
    public PatientView getPatientViewById(Long patientId) {
        PatientEntity patientEntity = patientRepository.findById(patientId)
                .orElseThrow(() -> new ResourceNotFoundException("Patient not found with ID: " + patientId));
        // Ensure related User and Address are loaded for the view
        return patientMapper.toView(patientEntity);
    }
}
